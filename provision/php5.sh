...
sudo mkdir /etc/apache2/sites-vagrant
sudo cp -R /vagrant/sites/* /etc/apache2/sites-vagrant

echo "Include sites-vagrant/" | sudo tee -a /etc/apache2/apache2.conf
...
echo "ServerName localhost" | sudo tee /etc/apache2/conf-enabled/fqdn
